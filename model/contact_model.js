...
async function createContact(prenom,nom,email,telephone_portable,telephone_fixe, fonction, est_principal,id_societe) {
    try {
        const {rows} = await db.query('INSERT INTO public."Contact" (prenom_contact, nom_contact, email_contact, telephone_portable_contact, telephone_fixe_contact, fonction_contact, est_principal_contact, id_societe_contact) VALUES($1, $2, $3, $4, $5, $6, $7, $8);', [prenom,nom,email,telephone_portable,telephone_fixe, fonction, est_principal,id_societe])
        return rows
    }
    catch (e) {
        console.log(e)
...
async function updateContact(id,prenom,nom,email,telephone_portable,telephone_fixe, fonction, est_principal,id_societe) {
    try {
        const res = await db.query('UPDATE public."Contact" SET ' +
            ...
            'fonction_contact =$7,est_principal_contact = $8, id_societe_contact = $9 ' +
